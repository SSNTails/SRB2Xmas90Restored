...
consvar_t cv_stbaroverlay = {"overlay","h",CV_SAVE,NULL}; // Default this in code instead of relying on config.cfg SSNTails 03-10-2024
...
//                             SCY(198)-(16*vid.dupy),
             ...
             if (rendermode == render_soft)
                 V_DrawScalePic(SCX(16), SCY(42), 0, sbohealth); // Was a number I forget and 198 =) Tails 10-31-99
             break;
