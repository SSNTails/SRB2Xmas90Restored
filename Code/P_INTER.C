...
//    }
    ...
    switch (special->sprite)
    {
      ...
      case SPR_BON1:
        ...
        player->mo->health = player->health;
//        P_SpawnMobj (special->x,special->y,special->z + (special->info->height / 2), MT_SPARK); // v0.90 did not have MT_SPARK SSNTails 03-10-2024
...
// Tails bounce code moved here 12-05-99
    ...
    if(player) {
              ...
              if((player->mo->health > 1 || player->armortype) && !(damage==9999))
                {
